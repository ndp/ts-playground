...
example('quick example', () => {
  ...
  assert.ok(customElements.get('x-greeting'))
})
...
example('unobserved attributes', () => {
  ...
  assert.ok(customElements.get('c-unobserved'))
})
...
example('manual attribute binding', () => {
  ...
  assert.ok(customElements.get('c-bound'))
})
...
example('parsed attributes', () => {
  ...
  assert.equal(counter['data-count'], 0)
})
...
example('sub-element wiring', () => {
  ...
  assert.ok(customElements.get('c-subelems'))
})
...
example('required vs optional sub-elements', () => {
  ...
  assert.ok(customElements.get('c-form'))
})
...
example('typed sub-elements', () => {
  new ComponentBwilder()
    ...
    .wAfterUpdateFn(function () {
      ...
      assert.ok(typeof emailValue === 'string' || typeof emailValue === 'undefined')
    })
    .bwild()
...
example('CSS modes', () => {
  ...
  assert.ok(customElements.get('c-css-adopted'))
  assert.ok(customElements.get('c-css-inline'))
})
...
example('async lifecycle hooks', async () => {
  ...
  assert.ok(customElements.get('c-async'))
...
example('ElementDescriptor for type-safe sub-elements', () => {
  ...
  assert.ok(descriptor.email)
  assert.ok(descriptor.submit)
})
...
example('slot assigned-element handling', () => {
  ...
  assert.ok(customElements.get('c-slot-demo'))
})
